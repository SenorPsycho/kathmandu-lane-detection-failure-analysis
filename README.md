...
1. **HSV color filtering** - filtering for yellow/white marking colors before edge detection. Correctly produced near-zero output on Kathmandu footage (no markings exist to detect), confirming the bottleneck is signal absence, not color space.
